...
This repository contains the implementation for the JASA paper [Testing Directed Acyclic Graph via Structural, Supervised and Generative Adversarial Learning](https://arxiv.org/pdf/2106.01474.pdf) in Python. 
